...
console.log(
  list
    .interleave(Immutable.Seq.of("A", "B", "C", "D", "E", "F", "G"))
    .toJS()
);
...
console.log(
  list
    .zip(
      Immutable.Seq.of("one", "two", "three", "four", "five", "six")
    )
    .toJS()
);
...
console.log(
  list
    .zipWith(
      ...
      Immutable.Seq.of(4, 5, 6),
      Immutable.Seq.of(7, 8, 9)
    )
    .toJS()
);
// [[1,4,7], [2,5,8], [3,6,9]]
